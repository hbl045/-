...
public class MPUtil {
     ...
     * @return
     */
    public static String camelToUndeline(String param){
    ...
    public static void main(String[] ages){System.out.println(camelToUndeline("ABCddfANM"));}
    ...
    public static Map camelToUnderlineMap(Map param,String pre){
        ...
        while (it.hasNext()){
            Map.Entry<String,Object> entry = it.next();
            String key = entry.getKey();
            String newKey = camelToUndeline(key);
            if(pre.endsWith(".")){
