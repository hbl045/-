  ...
  <div>
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" label="企业邮箱" prop="qiyeyouxiang">
            <el-input v-model="ruleForm.qiyeyouxiang"
                      placeholder="企业邮箱" clearable></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.qiyeyouxiang" label="企业邮箱" prop="qiyeyouxiang">
              <el-input v-model="ruleForm.qiyeyouxiang"
...
<script>
// 数字，邮件，手机，url，身份证校验 isNumber, isIntNumer, isURL, checkIdCard
