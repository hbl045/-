      ...
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" label="企业编号" prop="qiyebianhao">
            <el-input v-model="ruleForm.qiyebianhao" placeholder="企业编号" clearable></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" label="招聘岗位" prop="zhaopingangwei">
            <el-input v-model="ruleForm.zhaopingangwei" placeholder="招聘岗位" clearable></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.zhaopingangwei" label="招聘岗位" prop="zhaopingangwei">
              <el-input v-model="ruleForm.zhaopingangwei" placeholder="招聘岗位" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
...
<script>
//数字、邮件手机、url、身份证校验
// import {isNumber,isIntNumber,isEmail,isMobile,isURL,checkIdCard} from "@/utils/validate";
...
//         var obj = this.$stroage.getObj('crossObj');
//         for(var o in obj){
//           if(o == 'qiyebianhao'){
...
//                   this.parent.yingpinxinxiCrossAddOrUpateFlag = false;
//                   this.parent.search();
//                 }
//               });
//             }else{
